...
<header>
        <table style="border-spacing: 0em;">
            <tr>
							...
							@else
								<td  style="text-align: right;"><img class="img-responsive" width="50" height="40" src="{{ asset('images/oneclasslogox.png') }}" alt="Logo" style=" display: block;"></td>									
							@endif
...
<main style="font-size: 11pt;">
    ...
    <div style="text-align: center;">
		<h3 style="text-decoration: underline;">
			CONTRATO PARA LA ADQUISICIÓN DE NOCHES DE ALOJAMIENTO Y PAQUETES TURISTICOS CON DESCUENTO
		</h3>
		<br>
	</div>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">1.1</strong>
				</td>
        ...
        <?php else: ?>
          ...
          <td>
			...
			mayor de edad, de estado civil soltero, con cédula de identidad número {{$contrato->one_representante_cedula}},domiciliado en la ciudad de {{$contrato->one_representante_ciudad}}, parte que en adelante y para efectos del presente contrato, se podrá denominar <strong>“EL CONTRATISTA”.</strong>
          </td>
        <?php endif; ?>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">1.2</strong>
				

					<strong style="text-transform: uppercase;"><?php echo strtoupper(@$titular->nombre." ".@$titular->apellido); ?></strong>, mayor de edad,
					 <?php if (@$titular->cedula) { ?>
					...
					<strong>
					 ...
					 domiciliado en la ciudad de <strong><?php echo strtoupper(@$titular->ciudad);?></strong>, a quien en lo sucesivo podrá denominarse también <strong>“EL CLIENTE</strong>
				</td>
			</tr>
		</table>
		<br><br>
	...
	<div style="margin-left: 50px;text-align: justify;margin-top: 0px">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">2.1</strong>
	...
	<div style="margin-left: 50px;text-align: justify; margin-top: 0px">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">2.2</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">2.3</strong>
				...
				<!--<td>
					...
					<!--<strong>CLIENTE:</strong> Es el señor(a) <strong style="text-transform: uppercase;"><?php echo strtoupper(@$titular->nombre." ".@$titular->apellido); ?></strong>.
				</td>-->
			</tr>
		</table>
		<br><br>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">2.4</strong>
				</td>

				<td>
					<strong>PORTAFOLIO GOLDEN NIGHT:</strong>Conjunto de los servicios de paquetes turísticos y beneficios de descuentos que adquiere <strong>EL CLIENTE</strong>en virtud del presente contrato: 
				</td>
			</tr>
		</table>
			...
			<tr>
			<td >
					<strong style="margin-right: 10px;">2.4.1</strong>
				</td>

				<td>
					Cantidad de noches de alojamiento adquiridas por el cliente para el uso en hoteles de tres estrellas en convenio, en Ecuador, pudiendo ser éste el Hotel Playa Dorada o cualquier otro de la misma categoría. 
				</td>
			</tr>
			<tr>
			<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">2.4.2</strong>
				</td>

				<td>
					Como beneficio adicional de cortesía por la adquisición de las noches de hotel referidas, <strong>EL CLIENTE</strong> se hace acreedor a los siguientes beneficios de descuentos en Paquetes de servicios turísticos
			...
			<tr>
			<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">2.4.3</strong>
				</td>

				<td>
					 <strong>PORTAFOLIO GOLDEN NIGH NACIONAL PORTAFOLIO GOLDEN NIGH NACIONAL</strong> 
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">2.5</strong>
				</td>

				<td>
				<strong>CHEQUERA GOLDEN NIGHT:</strong> Talonario de cheques que constituyen el instrumento de canje de los paquetes de noches de alojamiento adquiridas por <strong>EL CLIENTE</strong> en el <strong> PORTAFOLIO GOLDEN NIGHT.</strong> En este talonario se detalla la cantidad de noches de alojamiento adquiridas y las condiciones de uso de éstas. 
				</td>
			</tr>
		</table>
		<br><br>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">2.6</strong>
				</td>
	...
	<!--<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">2.8</strong>
				</td>

				<td>
					<strong>PARTE O PARTES:</strong> 2.1.	significa las personas naturales y/o jurídicas firmantes, según sean individual o colectivamente referidas.
				</td>
			</tr>
		</table>
		<br><br>
	...
	<div style="text-align: justify;">
		...
		No obstante que el plazo de vigencia del CONTRATO comenzará a discurrir desde su suscripción, <strong>El CLIENTE<strong> declara conocer que no podrá hacer uso del<strong> PORTAFOLIO GOLDEN NIGHT </strong>
		hasta haber cancelado el valor total descrito en la cláusula quinta.
		Este contrato podrá ser renovado en términos similares, si así lo convinieren las partes hasta <strong>NOVENTA (90)</strong> días antes del vencimiento del
		 plazo indicado previamente.
		 Una vez fenecido el plazo de vigencia y de no existir un acuerdo de renovación según lo establecido en esta cláusula, el contrato se entenderá terminado.
		 <br>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">5.1</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">5.2</strong>
				</td>
              ...
              echo "CERO";
						...
						(USD <?php echo @$contrato->pagoInicial ?>),</strong>
	...
	<?php if((@$contrato->saldoFinanciado > 0) && (@$contrato->saldoInicial > 0)){ ?>
			<div style="margin-left: 50px;text-align: justify;">
				<table>
					<tr>
						<td style="vertical-align: top;">
							<strong style="margin-right: 20px;">5.3</strong>
						</td>
			...
			<div style="margin-left: 50px;text-align: justify;">
				<table>
					<tr>
						<td style="vertical-align: top;">
							<strong style="margin-right: 20px;">5.4</strong>
						</td>
	...
	<div style="text-align: justify;">
		<strong>SOBRE TEMPORADAS VACACIONALES Y CALENDARIOS DE AÑOS TURISTICOS </strong>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">6.1</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">6.2</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">6.3</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">6.4</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">6.5</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">7.1</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">7.2</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">7.3</strong>
				</td>
...
<br>
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">8.1</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">8.2</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">8.3</strong>
				</td>

				<td>
					<strong>BENEFICIARIOS SERVICIOS TURISTICOS CON DESCUENTO</strong> 
				</td>
			</tr>
		</table>
			<div style="margin-left: 20px;text-align: justify;">	
			...
			<tr>
			<td >
					<strong style="margin-right: 10px;">8.3.1</strong>
				</td>
			...
			<tr>
			<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">8.3.2</strong>
				</td>
			...
			<tr>
			<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">8.3.3</strong>
				</td>
...
<div style="margin-left: 50px;text-align: justify;">
		<table>
			...
			<tr>
			<td >
					<strong style="margin-right: 10px;">8.4.1</strong>
				</td>
			...
			<tr>
			<td style="vertical-align: top;">
					<strong style="margin-right: 10px;">8.4.3</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">9.1</strong>
				</td>
			...
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">9.2</strong>
				</td>
			...
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">9.3</strong>
				</td>
			...
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">9.4</strong>
				</td>
			...
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">9.5</strong>
				</td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">12.1</strong>
				</td>
				<td>
	...
	<div style="margin-left: 50px;text-align: justify;">
		<table>
			<tr>
				<td style="vertical-align: top;">
					<strong style="margin-right: 20px;">12.2</strong>
				</td>
	...
	<div style="text-align: justify;">
		Las <strong>PARTES</strong> afirman y ratifican en todo el contenido de este contrato, firmándolo en unidad de acto y por duplicado, en la ciudad de
		 <?php 
	...
	<div style="text-align: center;">
		<h3>
			<strong>FORMAS Y CONDICIONES DE USO DE LAS NOCHES DE ALOJAMIENTO ADQUIRIDAS Y BENEFICIOS DE DESCUENTOS EN SERVICIOS TURÍSTICOS QUE ESTÁN INCLUIDOS EN EL PORTAFOLIO GOLDEN NIGHT</strong>
		</h3>
	...
	<!-- aqui termina este div q agrege-->
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table style="width:100%;">
				<tr>
					<td >
						Para dar uso a los Beneficios de Descuentos en Servicios Turísticos descritos en la cláusula <strong>2.4.3.</strong> del <strong>CONTRATO,</strong> que son complementarios y constituyen un beneficio adicional de cortesía a las noches de alojamiento contratadas, <strong>EL CLIENTE</strong> deberá cumplir y observar las siguientes directrices:
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table style="width:100%;">
				<tr>
					...
					<td>
						____
						Los porcentajes de descuentos que constituyen un beneficio adicional de cortesía a las noches de alojamiento contratadas y el mejor precio de garantía descrito previamente, serán solo aplicables contra adquisición de los servicios brindados por <strong>WORLDCLASS ECUADOR S.A.</strong> y bajo ningún concepto serán retribuibles o exigibles en dinero.
					</td>
				</tr>
			</table>
			<br>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">22.</strong>
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">23.</strong>
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">24.</strong>
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">25.</strong>
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">27.</strong>
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">28.</strong>
					</td>
		...
		<div style="margin-left: 50px;text-align: justify;">
			<table>
				<tr>
					<td style="vertical-align: top;">
						<strong style="margin-right: 5px;">29.</strong>
					</td>
	...
	<div style="text-align: justify;">
		El CLIENTE tendrá derecho de recibir los siguientes beneficios durante un periodo de
		<strong><?php echo strtoupper(valorEnLetras($contrato->anosOtorgados)); ?>
			...
			?>
		 (<?php echo $contrato->anosOtorgados ?>)</strong>
		 y con un número de beneficiarios máximo de <strong><?php echo strtoupper(valorEnLetras($contrato->beneficiarios)); ?>
	  	<?php
			...
			?>
			 (<?php echo $contrato->beneficiarios ?>)</strong> contados a partir de la firma del presente contrato:
	...
	<div style="text-align: justify;">
		Para <strong>{{$contrato->one_empresa}}</strong> y su equipo de trabajo es un placer darle la más cordial bienvenida a nuestro <strong>CLUB ONE CLASS</strong> nos permitimos
		...
		<strong>PORTAFOLIO ONE CLASS</strong> tiene preparado para ustedes. Con el ánimo de poderles atender y responder de manera eficaz e inmediata,
	...
	<div style="text-align: center;color: #2196F3;">
		<h4>
			PARA SOLICITAR UNA RESERVA INGRESE A LA PAGINA WEB COMO AFILIADO Y DILIGENCIE EL FORMULARIO PARA SU COTIZACION O RESERVA.
			ESTIMADO PARA UNA MAYOR, EFICAZ Y PERSONALIZADA ATENCION RECUERDE SOLICITAR SU CITA PREVIA
		</h4>
		<br>
	</div><br>
