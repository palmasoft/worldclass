...
<br>
	<div style="text-align: justify;">
        ...
        <?php if ($contrato->created_at < '2018-07-31'): ?>
          <td>
            La compañía<strong>WORLDCLASS ECUADOR, S.A..</strong>,con Registro Único de Contribuyentes número RUC <strong>0993007080001</strong>, representada legalmente por el señor <strong>SEGUNDO JAVIER CASIERRA BACILIO</strong>, mayor de edad, de estado civil soltero, con cedula de ciudadanía número <strong>090809193-7</strong>, domiciliado en la ciudad de Guayaquil, parte que en adelante y para efectos del presente contrato, se podrá denominar <strong>“EL CONTRATISTA”.</strong>
          </td>
        <?php else: ?>

          <td>
              <strong>{{$contrato->one_representante}}</strong>, {{$contrato->one_representante_nacionalidad}}, 
						mayor de edad, de estado civil soltero, con cédula de identidad número <strong> {{$contrato->one_representante_cedula}},</strong>
						domiciliado en la ciudad de {{$contrato->one_representante_ciudad}}, quien ejerce actividades mercantiles bajo el nombre comercial de 
						<strong>{{$contrato->one_empresa}}</strong>,
            parte que en adelante y para efectos del presente contrato, se podrá denominar <strong>“EL CONTRATISTA”</strong>
...
<br>
    ...
    <div style="text-align: justify;">
		<table style="text-align: justify;">
		  	<tr style="vertical-align: top;">
				<td >
					<strong style="margin-right: 8px;">9.5</strong>
				</td>
			...
			<tbody>
				<tr>
					<td style="text-align: center;width: 50%;">
						...
						<strong>RUC.0993007080001</strong><br><br><br>
...
<br>
    ...
    <div style="text-align: center;">
        reservas@worldclass.com.ec
	</div>
    <div style="text-align: center;">
        serviwc@worldclass.com.ec
	</div>
    <br>
